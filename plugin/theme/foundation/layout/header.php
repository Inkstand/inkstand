...
<head>
	...
	<meta charset=utf-8 />
	<link rel="stylesheet" type="text/css" href="<?php echo WWW . '/plugin/theme/admin/css/style.css'; ?>">
	...
	<script type="text/javascript" src="<?php echo WWW . '/plugin/theme/admin/js/quickfacts.js'; ?>"></script>
